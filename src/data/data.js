...
export const projects = [
  {
    id: 1,
    title: "HowestPrime - Cinema App",
    description: "A microservices-based cinema management system using Domain Driven Design. Features a web platform for reservations (.NET Blazor) and an Android app for staff (Kotlin). Infrastructure managed with Terraform on Azure.",
    tech: [".NET", "Kotlin", "Azure", "Terraform", "Microservices"],
  ...
  },
  {
    ...
    description: "An online multiplayer version of the board game Splendor. Built with a Vue.js frontend and a robust Java backend handling game logic, turn management, and scoring. Includes comprehensive JUnit tests.",
    tech: ["Vue.js", "Java", "JUnit", "Rest API"],
